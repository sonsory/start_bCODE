...
////
                ...
                video1.setAttribute("style", "margin:0 auto;  top:160px; left: 430px; width:"+a+"px; height:"+a+"px;position: absolute; z-index: -1 ") //top의 기준은 video1 엘리먼트의 시작위치인듯.
...
//context.drawImage(video, 160+th, 240+th, 160-th*2, 160-th*2, 0, 0, 150, 150); // 이것은 코드 스캔용으로 적당할 듯.
 //context.drawImage(video, 335+th, 501 +th, 450-th*2, 450-th*2, 0, 0, 480, 480); 18.02.08
  context.drawImage(video, 360+th, 560+th, 60-th*2, 60-th*2, 0, 0, 150, 150); //
