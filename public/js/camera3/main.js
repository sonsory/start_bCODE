...
function findPosition(){
  ...
  context.drawImage(video, 291+th, 458+th, 120-th*2, 120-th*2, 0, 0, 140, 140);
  ...
  var imageData = context.getImageData(0, 0, 140, 140); // -original: context.getImageData(0, 0, 150, 150);
